            ...
            switch (cmd) {
                ...
                case 'about':
                    this.showPopup(
                        ...
                        '<span style="color:#1E3A8A;font-weight:700">CORE PILLARS</span><br>' +
                ...
                case 'security':
                    this.showPopup(
                        ...
                        '<span style="color:#F9FAFB;font-weight:700">COMPLIANCE</span><br>' +
                ...
                case 'status':
                    this.showPopup(
                        ...
                        '<span style="color:#F9FAFB;font-weight:700">● PROTECTION STATUS: GREEN</span><br><br>' +
                ...
                case 'threat':
                    this.showPopup('INTELLIGENCE', 'Threat Radar',
                        '<span style="color:#F9FAFB">● No active APT groups detected on Trigon infrastructure.</span><br>' +
                ...
                case 'collaborate':
                    ...
                    this.showPopup(
                        ...
                        '<div style="color:rgba(249, 250, 251,0.5);font-size:0.85rem;line-height:1.6">We are building a dedicated collaboration portal<br>for enterprise partnerships and research programs.<br><br>' +
                        '<span style="color:#1E3A8A">Stay tuned — access opens Q3 2026.</span>' +
                        '</div></div>'
                    );
                    break;
                ...
                default:
                    this.terminal.printLine(
                        `Command not found: <span style="color:#F97316">${cmd}</span>. Type <span style="color:#F97316">'help'</span> for available commands.`,
                        'error'
                    );
            }
        } catch (err) {
