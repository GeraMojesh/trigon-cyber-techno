...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (navToggle && navLinksContainer) {
        ...
        const mobileLinks = navLinksContainer.querySelectorAll('.nav-link');
    ...
    form?.addEventListener('submit', async (e) => {
        ...
        if (submitBtn) {
            submitBtn.textContent = 'Launching Mail Client...';
        ...
        try {
            ...
            window.location.href = `mailto:trigoncybertechno@gmail.com?subject=${subject}&body=${body}`;
            
            if (formStatus) {
                formStatus.textContent = '✓ Mail client launched.';
